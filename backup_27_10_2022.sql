...
INSERT INTO `adscripta` VALUES ('1');
...
INSERT INTO `antecedentes` VALUES (1,'Reprobó con 6, tiene que dar el examen el 31/09. Su peor tema son los vectores.','Física','2'),(2,'Reprobo con 7, en el examen solo va a dar el tema de subconsultas','Base de Datos','3'),(3,'Reprobo con 5, tiene que dar examen de Limites, Multiplicacion de signos y graficas','Matematica','2'),(4,'Reprobo con 4, Examen completo','Sistemas Operativos','1'),(5,'Reprobo con 6, tiene que dar examen de Derivadas, Ordenes y Logaritmos','Matematica','3'),(6,'Reprobo con 3, examen igual al parcial final.','Programacion','1');
...
INSERT INTO `asiste` VALUES (1,'6',1,'2021-08-17 03:00:00','Justificada',0.5,'Septima'),(2,'6',2,'2022-10-19 03:00:00','Llegada Tarde',0.5,'Primera'),(3,'6',3,'2022-11-13 03:00:00','Falta',1,'Octava'),(4,'6',4,'2022-04-02 03:00:00','Falta',1,'Segunda'),(5,'6',4,'2022-04-02 03:00:00','Asistencia',0,NULL),(6,'6',5,'2022-04-02 03:00:00','Asistencia',0,NULL),(7,'15',4,'2022-04-02 03:00:00','Llegada Tarde',0.5,'Segunda'),(8,'15',5,'2022-04-02 03:00:00','Asistencia',0,'Tercera'),(9,'16',4,'2022-04-02 03:00:00','Falta',1,'Segunda'),(10,'16',5,'2022-04-02 03:00:00','Falta',1,'Tercera'),(11,'17',4,'2022-04-02 03:00:00','Assitencia',0,'Segunda'),(12,'17',5,'2022-04-02 03:00:00','Asistencia',0,'Tercera');
...
INSERT INTO `clase` VALUES (1,'Teorico','Introducción a los Permisos','2022-03-26 03:00:00',1),(2,'Practico','Ejercicio Permisos','2022-10-19 03:00:00',2),(3,'Practico','Ejercicio MER','2022-11-13 03:00:00',3),(4,'Teorico','Fisica','2022-04-02 03:00:00',1),(5,'Teorico','Que son los vectores','2022-04-06 03:00:00',2),(6,'Teorico-Practico','Limites y formulas','2022-03-25 03:00:00',1),(7,'Practico','Ejercicios de limites y formulas','2022-04-01 03:00:00',2),(8,'Practico','Ejercicios con Vectores','2022-04-15 03:00:00',3),(9,'Teorico','Limites y formulas','2022-03-25 03:00:00',1),(10,'Practico','Ejercicios de Limites y formulas','2022-03-29 03:00:00',2),(11,'Teorico','Liberalismo en la economia','2022-03-25 03:00:00',1),(12,'Practico','Ejercicio leer texto e indicar porque es liberalista','2022-04-02 03:00:00',2),(13,'Teorico','Introduccion a SQL y crear tablas','2022-03-27 03:00:00',1),(14,'Teorico','Continuacion de SQL y atributos','2022-03-30 03:00:00',2),(15,'Teorico-Practico','Formulas para calcular velocidad','2022-04-20 03:00:00',4);
...
CREATE TABLE `controladopor` (
  ...
  `anoCursa` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `idGrupo` int NOT NULL,
  `idMat` int NOT NULL,
  `cedProf` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`idLib`,`idCursa`,`anoCursa`,`idGrupo`,`idMat`),
  KEY `idCursa` (`idCursa`),
  KEY `anoCursa` (`anoCursa`),
  KEY `idGrupo` (`idGrupo`),
  KEY `idMat` (`idMat`),
  KEY `cedProf` (`cedProf`)
...
INSERT INTO `controladopor` VALUES (1,1,'2021-01-01 03:00:00',1,1,'25'),(2,2,'2022-01-01 03:00:00',2,2,'5'),(3,5,'2022-01-01 03:00:00',3,3,'24'),(4,6,'2022-01-01 03:00:00',1,3,'24'),(5,7,'2022-01-01 03:00:00',2,3,'24'),(6,4,'2022-01-01 03:00:00',3,6,'23'),(7,8,'2022-01-01 03:00:00',2,1,'25'),(8,9,'2022-01-01 03:00:00',3,2,'5');
...
INSERT INTO `coordinacon` VALUES (1,'5','7','2022-04-30 03:00:00','Sociología en Sistemas Operativos (linux)');
...
CREATE TABLE `cursa` (
  ...
  `ano` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `idGrupo` int NOT NULL,
  `idMat` int NOT NULL,
...
INSERT INTO `cursa` VALUES (1,'2021-01-01 03:00:00',1,1,'Normalización, DLL, Permisos, Roles',NULL,'Septima ','2022-03-26 03:00:00'),(2,'2022-01-01 03:00:00',2,2,'Fisica Fisica',NULL,'Segunda','2022-04-02 03:00:00'),(4,'2022-01-01 03:00:00',3,6,'Liberalismo y Capitalismo',NULL,'Tercera','2022-03-25 03:00:00'),(5,'2022-01-01 03:00:00',3,3,'Limites, Graficas','Limites y Logaritmos','Novena','2022-03-25 03:00:00'),(6,'2022-01-01 03:00:00',1,3,'Limites, Ordenes y Derivadas',NULL,'Primera','2022-03-28 03:00:00'),(7,'2022-01-01 03:00:00',2,3,'Limites y Graficas',NULL,'Cuarta','2022-04-01 03:00:00'),(8,'2022-01-01 03:00:00',2,1,'Mer, Intro a SQL, Consultas','Mer, Intro a SQL, Consultas y Condiciones','Septima','2022-03-27 03:00:00'),(9,'2022-01-01 03:00:00',3,2,'Cosas de fisica, vectores',NULL,'Tercera','2022-04-01 03:00:00');
...
INSERT INTO `domicilio` VALUES (1,'Atenas','Belloni','General Flores',3028,NULL),(2,'Pilcomayo','Amazonas','Rio de la Plata',4980,NULL),(3,'Avenida Italia','Minnesota',NULL,3204,'12B'),(4,'Maldonado','Gboto','Magallanes',8825,'302');
...
INSERT INTO `emite` VALUES (3,1,'2022-05-24 03:00:00'),(4,2,'2022-05-20 03:00:00'),(7,3,'2022-05-25 03:00:00');
...
INSERT INTO `estudiante` VALUES ('6',17),('8',17),('9',18),('10',18),('11',20),('',NULL),('13',20),('14',19),('15',18),('16',18),('17',19),('18',18),('19',20),('20',20),('21',22),('22',21);
...
CREATE TABLE `grupo` (
  ...
  `año` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idGrupo`)
...
INSERT INTO `grupo` VALUES (1,'EMT','3','Informatica','2022-01-01 03:00:00'),(2,'EMT','2','Informatica','2022-01-01 03:00:00'),(3,'EMT','2','Deporte','2022-01-01 03:00:00');
...
INSERT INTO `haceinforme` VALUES (1,'5',1,'Nefasto, les va atodos mal y no me prestan atención :c','Malo, deberían ponerle mas ganas a la clase'),(2,'7',1,'Cumplieron todos los objetivos','Estan bien'),(3,'5',3,'Falto un tema','Podria ser un poco mejor'),(4,'24',3,'Estamos por terminar el ultimo tema de la primera etapa','Trabajan bien'),(5,'23',4,'Faltaron dar dos temas','Se distraen mucho'),(6,'25',7,'No falto ningun tema','Son atentos y hacen los deberes. Trabajan Bien');
...
INSERT INTO `persona` VALUES ('1','1111','Ads@gmail.com','Mariana','Maria','Guillón','Del Toro','1987-09-23 03:00:00','AdscriptPRO',1,NULL),('2','2222','Sec@gmail.com','Valeria',NULL,'Perez','Rodriguez',NULL,'ValPer',1,NULL),('3','3333','Ins@gmail.com','Eduardo','Pablo','Estrada','Cabrera','1992-12-12 03:00:00','inspectorGadget',1,NULL),('4','4444','Coor@gmail.com','Natalia',NULL,'Torres','Ortíz',NULL,'NatTorLaMeJor',1,NULL),('5','5555','Prof@gmail.com','Sebastian','Eugenio','Torres','Nuñez','1977-02-18 03:00:00','1234',1,NULL),('6','6666','Est@gmail.com','Santiago','Emanuel','Soto','Salgueiros','2004-01-30 03:00:00','69420',1,NULL),('7','7777','Prof2@gmail.com','Ana','Paula','Coronel','Coronela',NULL,'socEsLoMejor',1,NULL),('8','880011','delfinatalamas@gmail.com','Delfina',NULL,'Talamás','Oberti','2004-12-28 03:00:00','6969',0,NULL),('9','2619','supahfox@gmail.com','Fabricio',NULL,'Buzó','Sansberro','2004-06-18 03:00:00','sanshehe',0,NULL),('10','1010','NicoGames@gmail.com','Nicolas','Mateo','Gallardi','Llacer','2004-08-09 03:00:00','niconiconi',1,NULL),('11','1111','tommy@gmail.com','Tomas',NULL,'Piña','Colada','2002-11-03 03:00:00','piñaColada',1,NULL),('13','1133','germito@gmail.com','German','Allan','Delgado','Di Sabella','2002-01-15 03:00:00','1947',1,NULL),('14','1414','maticas@gmail.com','Matías',NULL,'Castro','Lasa','2003-04-21 03:00:00','soyElMejor',1,NULL),('15','1515','pedrobenja@gmail.com','Pedro','Benjamín','Chialanza','Arrieta','2004-05-27 03:00:00','uwu40',1,NULL),('16','1616','xxnachoxx@gmail.com','Ignacio','Matías','Ghan','Gómez','2004-12-30 03:00:00','5392',1,NULL),('17','1717','mederos@gmail.com','Mauro','Enrique','Mederos','Tolosa','2003-07-07 03:00:00','451426',1,NULL),('18','1818','facmen@gmail.com','Facundo','','Méndez','Bentos','2004-09-25 03:00:00','14545',1,NULL),('19','1919','juancito@gmail.com','Juan','Ignacio','Amaral','Río','2002-10-26 03:00:00','4631',1,NULL),('20','2020','mirinda@gmail.com','Santiago',NULL,'Miranda','Garcilazo','2002-03-30 03:00:00','7531',1,NULL),('21','2121','pablito@gmail.com','Pablo',NULL,'Suarez','Gimenez','2000-07-29 03:00:00','pepino07',0,NULL),('22','2222','axelRoxas@gmail.com','Axel','Nicolás','Mendez','Rosas','2001-10-09 03:00:00','16325',0,NULL),('23','2323','economy@gmail.com','Carlos','Segundo','Ramirez','Pereira','1998-05-23 03:00:00','46772',1,NULL),('25','2525','gabrielcito@gmail.com','Gabriel',NULL,'Cano','Canas','1995-12-09 03:00:00','merYSQL',1,NULL),('24','2424','hugito@gmail.com','Hugo',NULL,'De Los','Santos','1970-11-23 03:00:00','limites',1,NULL);
...
INSERT INTO `personas` VALUES ('1','Santiago','Emanuel','Soto','Salgueiros','santiagosotoesputo@gmail.com',696969,'2020-10-05','soyputoayuda'),('1','Santiago','Emanuel','Soto','Salgueiros','santiagosotoesputo@gmail.com',696969,'2020-10-05','soyputoayuda');
...
CREATE TABLE `pertenece` (
  ...
  `juicioMat` varchar(200) DEFAULT NULL,
...
INSERT INTO `pertenece` VALUES (1,'6',1,1,'2021-01-01 03:00:00',1,'le va bien'),(2,'6',2,2,'2022-01-01 03:00:00',1,'le va mal'),(2,'6',1,3,'2022-01-01 03:00:00',1,'le va mal'),(1,'8',1,1,'2021-01-01 03:00:00',2,'Le va bien'),(1,'9',1,1,'2021-01-01 03:00:00',3,'Le va mal'),(1,'10',1,1,'2021-01-01 03:00:00',4,NULL),(1,'11',1,1,'2021-01-01 03:00:00',5,NULL),(1,'13',1,1,'2021-01-01 03:00:00',6,NULL),(3,'6',1,6,'2022-01-01 03:00:00',1,NULL),(3,'8',1,6,'2022-01-01 03:00:00',2,NULL),(3,'9',1,6,'2022-01-01 03:00:00',3,NULL),(3,'10',1,6,'2022-01-01 03:00:00',4,NULL),(3,'11',1,6,'2022-01-01 03:00:00',5,NULL),(3,'13',1,6,'2022-01-01 03:00:00',6,NULL),(2,'14',2,2,'2022-01-01 03:00:00',2,NULL),(2,'15',2,2,'2022-01-01 03:00:00',3,NULL),(2,'16',2,2,'2022-01-01 03:00:00',4,NULL),(2,'17',2,2,'2022-01-01 03:00:00',5,NULL),(2,'9',2,2,'2022-01-01 03:00:00',6,NULL),(2,'18',2,2,'2022-01-01 03:00:00',7,NULL),(6,'19',3,4,'2022-01-01 03:00:00',1,NULL),(6,'20',3,4,'2022-01-01 03:00:00',2,NULL),(6,'21',3,4,'2022-01-01 03:00:00',3,NULL),(6,'22',3,4,'2022-01-01 03:00:00',4,NULL),(3,'19',3,5,'2022-01-01 03:00:00',1,NULL),(3,'20',3,5,'2022-01-01 03:00:00',2,NULL),(3,'21',3,5,'2022-01-01 03:00:00',3,NULL),(3,'22',3,5,'2022-01-01 03:00:00',4,NULL),(3,'14',2,7,'2022-01-01 03:00:00',1,NULL),(3,'15',2,7,'2022-01-01 03:00:00',2,NULL),(3,'16',2,7,'2022-01-01 03:00:00',3,NULL),(3,'17',2,7,'2022-01-01 03:00:00',4,NULL),(3,'18',2,7,'2022-01-01 03:00:00',5,NULL),(1,'14',2,8,'2022-01-01 03:00:00',1,NULL),(1,'15',2,8,'2022-01-01 03:00:00',2,NULL),(1,'16',2,8,'2022-01-01 03:00:00',3,NULL),(1,'17',2,8,'2022-01-01 03:00:00',4,NULL),(1,'18',2,8,'2022-01-01 03:00:00',5,NULL),(2,'19',3,9,'2022-01-01 03:00:00',1,NULL),(2,'20',3,9,'2022-01-01 03:00:00',2,NULL),(2,'21',3,9,'2022-01-01 03:00:00',3,NULL),(2,'22',3,9,'2022-01-01 03:00:00',4,NULL);
...
INSERT INTO `reunion` VALUES (1,'3','Todos se portan mal, hay que separar al grupito del fondo'),(2,'2',NULL),(3,'1','Hay grupos que hay que separar porque no prestan atencion, comportamiento general bien'),(4,'1','Comportamiento bien, necesitan un poco de ayuda con las tareas'),(5,'2',NULL),(6,'3',NULL),(7,'1','Se distraen mucho e interrumpen la clase, No trabajan bien individualmente'),(8,'2',NULL);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-10-18 14:47:17',NULL),('diagnostics.include_raw','OFF','2022-10-18 14:47:17',NULL),('ps_thread_trx_info.max_length','65535','2022-10-18 14:47:17',NULL),('statement_performance_analyzer.limit','100','2022-10-18 14:47:17',NULL),('statement_performance_analyzer.view',NULL,'2022-10-18 14:47:17',NULL),('statement_truncate_len','64','2022-10-18 14:47:17',NULL);
...
INSERT INTO `tiene` VALUES (1,1,'2021-01-01 03:00:00',1,1),(2,6,'2022-01-01 03:00:00',1,3),(3,2,'2022-01-01 03:00:00',2,2),(4,7,'2022-01-01 03:00:00',2,3),(5,4,'2022-01-01 03:00:00',3,6),(6,5,'2022-01-01 03:00:00',3,3);
...
CREATE TABLE `tiene2` (
  ...
  PRIMARY KEY (`idClase`,`idGrupo`,`idMat`,`idCursa`),
  KEY `idGrupo` (`idGrupo`),
  KEY `idMat` (`idMat`),
  KEY `idCursa` (`idCursa`),
  KEY `anoCursa` (`anoCursa`)
...
INSERT INTO `tiene2` VALUES (1,1,1,1,'2021-01-01 03:00:00','septima',0),(2,1,1,1,'2022-01-01 03:00:00','septima',0),(3,1,1,1,'2022-01-01 03:00:00','septima',0),(4,2,2,2,'2022-01-01 03:00:00','Segunda',0),(5,2,2,2,'2022-01-01 03:00:00','Segunda',0),(6,3,3,5,'2022-01-01 03:00:00','Novena',0),(7,3,3,5,'2022-01-01 03:00:00','Novena',0),(8,2,2,2,'2022-01-01 03:00:00','Segunda',0),(9,2,3,7,'2022-01-01 03:00:00','Cuarta',0),(10,2,3,7,'2022-01-01 03:00:00','Quinta',0),(11,3,6,4,'2022-01-01 03:00:00','Tercera',0),(12,3,6,4,'2022-01-01 03:00:00','Tercera',0),(13,2,1,8,'2022-01-01 03:00:00','Septima',0),(14,2,1,8,'2022-01-01 03:00:00','Septima',0),(15,2,2,2,'2022-01-01 03:00:00','Segunda',0);
...
INSERT INTO `tienea` VALUES ('10',2),('13',3),('15',4),('19',6),('22',5),('6',1);
...
INSERT INTO `tiened` VALUES ('11',3),('17',4),('6',1),('8',2);
...
CREATE TABLE `trabaja` (
  ...
  PRIMARY KEY (`idTrabaja`,`cedEst`,`idCursa`,`idMat`,`idGrupo`),
  KEY `cedEst` (`cedEst`),
  KEY `idMat` (`idMat`),
  KEY `idGrupo` (`idGrupo`),
  KEY `idCursa` (`idCursa`),
...
INSERT INTO `trabaja` VALUES (4,'6',2,'2022-01-01 03:00:00',2,2,'Escrito',6,NULL,NULL,NULL),(1,'6',1,'2021-01-01 03:00:00',1,1,'Oral',11,NULL,NULL,NULL),(2,'6',1,'2021-01-01 03:00:00',1,1,'Escrito',9,NULL,NULL,NULL),(3,'6',3,'2022-01-01 03:00:00',2,1,'TI',8,NULL,NULL,NULL),(5,'22',5,'2022-01-01 03:00:00',3,3,'Oral',12,NULL,NULL,NULL),(6,'22',5,'2022-01-01 03:00:00',3,3,'Escrito',9,NULL,NULL,NULL),(7,'14',2,'2022-01-01 03:00:00',2,2,'Escrito',6,NULL,NULL,NULL),(8,'14',2,'2022-01-01 03:00:00',2,2,'Oral',8,NULL,NULL,NULL),(9,'16',2,'2022-01-01 03:00:00',2,2,'Escrito',10,NULL,NULL,NULL),(10,'15',2,'2022-01-01 03:00:00',2,2,'Escrito',8,NULL,NULL,NULL),(11,'16',2,'2022-01-01 03:00:00',2,2,'Oral',9,NULL,NULL,NULL),(12,'8',1,'2021-01-01 03:00:00',1,1,'Oral',11,NULL,NULL,NULL);
...
--
-- Temporary view structure for view `verpersonas`
--

DROP TABLE IF EXISTS `verpersonas`;
/*!50001 DROP VIEW IF EXISTS `verpersonas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `verpersonas` AS SELECT 
 1 AS `cedula`,
 1 AS `cel`,
 1 AS `mail`,
 1 AS `pri_nom`,
...
CREATE TABLE `visa1` (
  ...
  PRIMARY KEY (`idVisado`,`cedIns`,`idGrupo`,`idMat`,`idCursa`),
  KEY `cedIns` (`cedIns`),
  KEY `idGrupo` (`idGrupo`),
  KEY `idMat` (`idMat`),
  KEY `idCursa` (`idCursa`),
...
INSERT INTO `visa1` VALUES (1,'2',1,1,1,'2021-01-01 03:00:00','Visado','2021-09-30 03:00:00','Todo esta bien');
...
INSERT INTO `visa2` VALUES (1,'2','6',1,1,'Visado','2022-09-30 03:00:00','No falta nada');
...
INSERT INTO `visa3` VALUES (1,'3',1,'6',1,'completo','2021-11-28 03:00:00','Terminado');
...
INSERT INTO `visa4` VALUES (1,'2',1,'5',1,'Visado','2022-09-30 03:00:00','Completo');
...
INSERT INTO `visa5` VALUES (1,'2',1,'5',1,'Visado','2022-09-30 03:00:00','Completo'),(1,'2',1,'7',2,'No Hecho','2022-09-30 03:00:00','No hay informe');
...
--
-- Final view structure for view `verpersonas`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `verpersonas` AS select 1 AS `cedula`,1 AS `cel`,1 AS `mail`,1 AS `pri_nom`,1 AS `seg_nom`,1 AS `pri_ape`,1 AS `seg_ape`,1 AS `fecha_nac`,1 AS `sigueTDB` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-10-27  3:47:45
